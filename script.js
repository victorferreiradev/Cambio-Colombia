...
document.getElementById("consultar").addEventListener("click", async () => {
  try {
    ...
    if (typeof XLSX === 'undefined') {
      throw new Error("A biblioteca XLSX não foi carregada corretamente. Verifique o caminho do arquivo.");
    }
...
// ================================================
// Inicialização - Configura datas padrão
// ================================================
(function init() {
  // Configura data inicial como 30 dias atrás
  const dataInicio = new Date();
  dataInicio.setDate(dataInicio.getDate() - 30);
  document.getElementById("data-inicio").valueAsDate = dataInicio;
  
  // Configura data final como hoje
